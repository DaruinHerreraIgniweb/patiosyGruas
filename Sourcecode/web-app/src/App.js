...
import InventoryDocuments from "views/InventoryDocuments.js";
...
import Patios from "views/Patios.js"; //Nueva vista
import EditPatio from "views/EditPatio.js"; //Nueva vista
import Auditorias from "views/Auditorias.js"; //Nueva vista
import Inventarios from "views/Inventarios.js"; //Nueva vista
          ...
          <AuthLoading>
           <BrowserRouter>
              <Routes>
                ...
                <Route path="/profile" element={<ProtectedRoute permit={"customer,admin,driver,fleetadmin,parkingOwner"}><MyProfile /></ProtectedRoute>}/>
                ...
                <Route path="/inventarios/cardocuments/:rId/:id" element={<ProtectedRoute permit={"admin,fleetadmin,parkingOwner"}><InventoryDocuments/></ProtectedRoute>} />  
                ...
                {/* Nuevas rutas */}
                <Route path="/auditorias" element={<ProtectedRoute permit={"admin"}><Auditorias /></ProtectedRoute>}/>
                <Route path="/patios" element={<ProtectedRoute permit={"admin,parkingOwner"}><Patios /></ProtectedRoute>}/>
                <Route path="/patios/editpatio" element={<ProtectedRoute permit={"admin,parkingOwner"}><EditPatio /></ProtectedRoute>}/>
                <Route path="/patios/editpatio/:id" element={<ProtectedRoute permit={"admin,parkingOwner"}><EditPatio /></ProtectedRoute>}/>

                <Route path="/inventarios" element={<ProtectedRoute permit={"admin,parkingOwner"}><Inventarios /></ProtectedRoute>}/>
