            ...
            {[
              {
                ...
                url: "/",
                icon: <HomeIcon />,
                access: ["admin", "fleetadmin", "driver", "customer", "parkingOwner"],
              },
              {
                name: t("dashboard_text"),
                url: "/dashboard",
                icon: <DashboardIcon />,
                access: ["admin", "fleetadmin"],
              },
              {
                name: t("booking_history"),
                url: "/bookings",
                icon: <ViewListIcon />,
                access: ["admin", "fleetadmin", "driver", "customer"],
              },
              {
              ...
              },
              {
                ...
                url: "/cars",
                icon: <CarIcon />,
                access: ["admin", "fleetadmin", "driver"],
              },
              {
                name: t("patio_offer_title"),
                url: "/patios",
                icon: <RoomIcon />,
                access: ["admin", "fleetadmin", "driver", "customer", "parkingOwner"],
                disabled: settings.disablePatios
              },
              {
                name: t("inventario_offer_title"),
                url: "/inventarios",
                icon: <InventoryIcon />,
                access: ["admin", "fleetadmin", "driver", "customer", "parkingOwner"],
              },
              {
                name: t("withdraws_web"),
                url: "/withdraws",
                icon: <MoneyIcon />,
                access: ["admin"],
              },
              ...
              },
              {
                ...
                url: "/userwallet",
                icon: <AccountBalanceWalletIcon />,
                access: ["driver", "customer", "fleetadmin"],
              },
              {
                ...
                >
                  ...
                  >
                    <ListItemButton
                      ...
                      dense={false}
                      component={Link}
                      to={item.url === "logout" ? null : item.url}
                      onClick={item.url === "logout" ? LogOut : null}
                    >
  ...
  return (
    <Box sx={{ display: "flex", direction: isRTL === "rtl" ? "rtl" : "ltr" }}>
      ...
      <AppBar
        ...
        style={
          isRTL === "rtl"
            ? { marginRight: drawerWidth, backgroundColor: MAIN_COLOR }
            : { marginLeft: drawerWidth, backgroundColor: MAIN_COLOR }
        }
        sx={{
      ...
      >
        <Toolbar>
          ...
          <Typography
            ...
            noWrap
            component="div"
            style={{ color: colors.WHITE, fontFamily: FONT_FAMILY }}
          >
