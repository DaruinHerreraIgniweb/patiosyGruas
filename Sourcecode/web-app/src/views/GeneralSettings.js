...
const GeneralSettings = (props) => {
  ...
  const handlePatiosRadius = (e) => {
    setData({ ...data, patiosRadius: parseFloat(e.target.value) >= 0 ? parseFloat(e.target.value) : '' });
  };
            ...
            <Grid container spacing={2} style={{ direction: isRTL === 'rtl' ? 'rtl' : 'ltr' }} >
              <Grid item xs={12} sm={12} md={6} lg={6} >
                ...
                <FormControlLabel
                  ...
                  control={
                    <Switch
                      checked={data.disablePatios}
                      onChange={handleSwitchChange}
                      name="disablePatios"
                      color="primary"
                    />
                  }
                  label={ <Typography className={classes.typography}>{t('disable_patios')}</Typography>}
                />
              ...
              <Grid item xs={12} sm={12} md={6} lg={6}>
                ...
                InputLabelProps={{ style: { fontFamily: FONT_FAMILY } }}
                  ...
                  fullWidth
                  id="patiosRadius"
                  label={t('patiosRadius')}
                  name="patiosRadius"
                  autoComplete="patiosRadius"
                  onChange={handlePatiosRadius}
                  value={data.patiosRadius}
                />
