          ...
          if(!validatePassword){
            if (validateMobile()) {
              ...
              if (userData.referralId && userData.referralId.length > 0){
                ...
                delete userData.country;
                const ogRole = userData.usertype;
                if (ogRole == 'parkingOwner') {
                ...
                mainSignUp(userData).then((res)=>{
                  if(res.uid){
                    if (ogRole == 'parkingOwner') {
                      let obj = data
                      obj.usertype = ogRole;
                      data.usertype = ogRole;
                      dispatch(editUser(res.uid, obj));
                    }
                      ...
                      >
                        <FormControl variant="standard" fullWidth>
                          ...
                          >
                            ...
                            <MenuItem value={"parkingOwner"}>
                              <Typography fontFamily={FONT_FAMILY}>{t("parkingOwner")}</Typography>
                            </MenuItem>
                          </Select>
                        </FormControl>
                      </GridItem>
