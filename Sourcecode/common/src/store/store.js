...
import { patiosreducer } from "../reducers/patiosreducer"; //Nuevo reducer
import { promoreducer } from "../reducers/promoreducer";
import { auditoriareducer } from "../reducers/auditoriareducer";
import { inventarioreducer } from "../reducers/inventarioreducer";
...
const rootReducer = {
  ...
  patiosdata: patiosreducer,
  auditoriasdata: auditoriareducer,
  inventariosdata: inventarioreducer,
